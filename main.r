...
visualize("tree1.txt", TRUE, "pruned_origin.pdf")
visualize("tree1.txt", FALSE, "not_pruned_origin.pdf")
visualize("tree2.txt", TRUE, "pruned_learnt.pdf")
visualize("tree2.txt", FALSE, "not_pruned_learnt.pdf")
